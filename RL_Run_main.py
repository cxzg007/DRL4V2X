...
def run_test(curr_RL_Config, BS_Agent, test_seed_sequence):
    ...
    if Opt_Flag:
        ...
        myExpect_Return = rl_utils.forward_fill(Expect_Return, 50)
        myRA_Expect_Return = rl_utils.forward_fill(RA_Expect_Return, 50)
        myOpt_Expect_Return = rl_utils.forward_fill(Opt_Expect_Return, 50)


        y = myExpect_Return
        y1 = myRA_Expect_Return
        y2 = myOpt_Expect_Return
        plt.figure()
        ...
        y = myExpect_Return / myOpt_Expect_Return
        y1 = myRA_Expect_Return / myOpt_Expect_Return
        y2 = myOpt_Expect_Return / myOpt_Expect_Return
